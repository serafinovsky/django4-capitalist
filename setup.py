...
setup(
    ...
    description='Python/Django client for capitalist.net',  # Optional
    ...
    keywords='development django capitalist',  # Optional
    ...
    install_requires=['requests', 'cryptography'],  # Optional
